...
4. 交换 token：
   ```bash
   python3 /home/wukong/wiseflow-pro/crews/content-producer/skills/bilibili-publish/scripts/publish_bilibili.py --exchange-token <code>
   ```
...
```bash
python3 /home/wukong/wiseflow-pro/crews/content-producer/skills/bilibili-publish/scripts/publish_bilibili.py \
  --title "视频标题" \
  --video video.mp4 \
  --tid 122 \
  --tags AI,科技,工具
