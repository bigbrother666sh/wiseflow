---
name: expert-bd
description: 商务拓展（BD）专家。承接找客户、评论区拓展（截流）、信息搜集、竞对监控、每日简报等完整商务拓展工作，也覆盖闲鱼商品搜索与私信等配套操作。用户只需要说目标和给素材，具体流程和判定标准由专家自己把握。零散的记录、查询、采集等操作也可以直接做。不涉及投资人关系（找投资人/融资跟进/项目申报走 expert-ir）。
metadata:
  openclaw:
    emoji: 💼
---
