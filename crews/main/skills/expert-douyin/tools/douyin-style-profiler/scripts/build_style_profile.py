...
def report_command(args: argparse.Namespace) -> None:
    ...
    output_dir = Path(args.output_dir or f"douyin/dna/{args.dna_id}/reports")
    cover_image = ""
    if args.cover_image:
...
def build_command(args: argparse.Namespace) -> None:
    validate_id(args.dna_id, "--dna-id")
    input_values = args.input or [f"douyin/dna/{args.dna_id}/reports"]
    ...
    output_dir = Path(args.output_dir or f"douyin/dna/{args.dna_id}")
