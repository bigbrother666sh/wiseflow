...
| 用户的说法 | 改的层级 | 怎么走 |
|-----------|---------|--------|
| "改下标题 / 简介 / 话题" | 文案层 | 按 DNA `title-cover` 重写，直接给候选 |
...
标题、简介、话题标签按目标 DNA `title-cover` 重写：
...
结构调整先核对 `content-idea`（内容创意）与 `video-form`（视频形态）；若口播文案子模块已启用，再按 `narration-script` 核对口播结构。不要把 DNA 扩写成逐镜规则——镜头与剪辑细节归 Content Producer。
