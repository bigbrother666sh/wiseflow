```
这份guide是从其他体系中移植过来的，我们要借鉴它里边的关键词提取方法，制作新的Workflow:拆解用户的诉求，制定对标内容搜索策略、搜索对应笔记(注意搜索策略：寻找低粉爆款。也就是关键词搜索以后，要看一眼作者、发布者的粉丝量，要跟自己的粉丝量近似)、下载、分析……
workflow 还应该吸收改造 crews/main/skills/expert-xhs/tools/xhs-content-ops （xhs-content-ops作为tool，应该只保留原子级的功能）
```
