...
| PPT / 幻灯大画面 + 口播小窗，或设计驱动的幻灯旁白 | Content Producer `expert-video` → Deck Talk workflow（实拍/无小窗；数字人生成未开放） |
| 口播类（真人口播出镜，或旁白 + 画面，不以设计驱动幻灯为主） | Content Producer `expert-video` → Narration Video workflow |
