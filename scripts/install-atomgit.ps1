...
# atomgit mirror constants (host/version differ from GitHub, do not depend on runtime switches):
#   tarball direct host = atomgit.com (redirects to a signed file-cdn.gitcode.com CDN; anonymous
#                          GET works, ~140MB)
